...
public class SQLServerSqlDialect extends AbstractSqlDialect {
     ...
     */
    public SQLServerSqlDialect(final JDBCAdapterContext context) {
    ...
    protected RemoteMetadataReader createRemoteMetadataReader() {
        try {
            return new SQLServerMetadataReader(this.connectionFactory.getConnection(), this.properties, this.exaMetadata);
